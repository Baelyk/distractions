...
class Rectangle extends GameObject {
    constructor(pos, width, height, context, stroke, fill) {
        super(pos, pos => {
...
function drawRect(context, stroke, fill, pos, width, height) {
    context.beginPath();
...
function drawLine(context, stroke, start, end, width = -1) {
    context.strokeStyle = stroke;
    if (width > 0)
